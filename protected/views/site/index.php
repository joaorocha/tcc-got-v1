...
<!--CENTRO-->
<div id="centro">
    <div class="wrapper" data-cycle-pause-on-hover="true">
    ...
    <script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl; ?>/assets/web/js/jquery.slicebox.js"></script>
    <script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl; ?>/assets/web/js/application.js"></script>
    <!--CAMPO DE NOTÍCIAS-->
