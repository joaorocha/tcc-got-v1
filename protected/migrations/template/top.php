...
<html lang="pt-BR">
    <head>
        ...
        <title>Game Of Thrones - The Game</title>
    </head>
    <body>
        <!--BARRA DE NAVEGAÇÃO-->
        <div id="navBar">
        ...
        <!--BANNER-->
        <div id="banner">
            <a href="index.php"><img src="img/bannergot2.png" width="930" height="300"></a>
        </div><!--BANNER-->
        <!--TUDO-->
        <div id="tudo">
            <!--MENU SUPERIOR-->
            ...
            <div id="lateral-esq">
                ...
                <div id="menu_lateral">
                    <ul class="navLat">
                        ...
                        <li><a href="about.php">Sobre GoT</a></li>
                    </ul>
                ...
                <div id="painel">
                    <ul class="painelLat">
                        ...
                        <li><a href="recover.php">Recuperar Senha</a></li>
